...
Please [open an issue](https://github.com/so-dang-cool/sigi/issues) if you see
bugs or have ideas!

I'm looking for people to use [the `sigi` wiki](https://github.com/so-dang-cool/sigi/wiki)
